...
# generate data, nnorm macht normalverteilte daten
data_wide <- 
...
data_wide_likert <- data_wide %>%
  mutate(across(starts_with("item_"), ~ round_half_up(.x, digits = 0))) %>% # mit across kann man gleich mehrere spalten mit gleichem code bearbeiten
...
negative selection: cols = -id
oder "contains": cols = contains ("tem_")

facet_wrap() ist to ggplot as group_bys() is to dplyr
